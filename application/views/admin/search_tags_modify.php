        ...
        <div class="container-fluid">
            <div class="row-fluid">
                ...
                <div class="span8">
                    ...
                    <?=form_open('admin/search_tags/modify_search_tags_process', array('class' => 'form-horizontal modify'))?>
                        <div class="alert alert-error" id="tips" style="display:none"></div>
                        <input type="hidden" name="search-tags-id" value="<?=$search_tags->id?>">
                        <div class="control-group">
                            <label class="control-label" for="title">搜索热词名称</label>
                            <div class="controls">
                                <input id="title" name="title" type="text" value="<?=$search_tags->title?>">
                            </div>
                        </div>
            ...
            var options = {
                ...
                success: function(info) {
                    if (info['status'] == 'error') {
                        ...
                        location.href = '<?=site_url('admin/search_tags')?>';
                    }
                }
            };
